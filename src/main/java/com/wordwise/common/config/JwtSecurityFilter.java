    ...
    protected void doFilterInternal(
        ...
        if (jwt != null) {
            try {
                ...
                UserRole userRole = UserRole.ofUserRole(claims.get("userRole", String.class));
                ...
                if(requestURI.equals("/api/v1/auth/token")){
                    log.info("AccessToken 재발급 API 요청 : securityException ***");
                ...
                httpResponse.getWriter().write("JWT UNAUTHORIZED ERROR JWT : " + e.getMessage());
                return;
